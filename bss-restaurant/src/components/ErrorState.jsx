      ...
      <div className="max-w-md w-full bg-white border-2 border-slate-100 rounded-4xl p-10 shadow-sm text-center">
        ...
        <div className="flex flex-col gap-3">
          {refetch && (
            <button
              onClick={() => refetch()}
              className="flex items-center justify-center gap-2 w-full bg-slate-900 hover:bg-slate-800 text-white px-6 py-4 rounded-[5px] font-black transition-all active:scale-[0.98] cursor-pointer"
            >

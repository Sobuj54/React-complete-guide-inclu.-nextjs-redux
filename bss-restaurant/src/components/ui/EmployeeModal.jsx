...
export default function EmployeeModal({ isOpen, onClose, title, children }) {
  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-end p-4 md:p-6 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="w-full max-w-6xl mx-auto h-full bg-white rounded-[3rem] shadow-2xl flex flex-col overflow-hidden animate-in slide-in-from-right duration-500">
